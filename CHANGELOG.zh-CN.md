...
- 修复 Windows 安装程序中针对旧版 Windows 的运行方案链接引用错误。
...
- 优化生成时内存占用。
- 优化生成时性能。
- 重构安装文档，按软件包类型拆分为独立页面，新增 Python 安装指南、pip install 警告及 InnoSetup 静默安装说明。
...
- 按 Diátaxis 框架重构用户文档，按开发生命周期重组开发者文档。
