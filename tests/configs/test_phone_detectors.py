...
class TestChinaMainlandPhoneDetector:
    ...
    @pytest.fixture
    def detector(self) -> PhoneDetector:
        return _get_detectors()["builtin.china.mainland"]

    def test_locale_territories(self, detector: PhoneDetector):
        assert "CN" in detector.locale_territories

    @pytest.mark.parametrize(
        "phone",
        [
            # Mobile: 11 chars without +86
            "13812345678",
            "14712345678",
            "15812345678",
            "16812345678",
    ...
    def test_valid(self, detector: PhoneDetector, phone):
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            "12812345678",
            # Length mismatch
            "1381234567",  # 10 chars, too short
            "138123456789",  # 12 chars, not 11 or 14
            "+861381234567",  # 13 chars with +86, not 14
            "+86138123456789",  # 15 chars with +86, not 14
            # Landline does not start with 0
            "1012345678",
            # Landline length outside range(10, 16)
            "010123456",  # 9 chars
            "0101234567890123",  # 16 chars
            "+8601012345",  # trailing part only 5 chars (< 7)
            "+860101234567890123",  # 20 chars
            # Empty
            "",
        ],
    )
    def test_invalid(self, detector: PhoneDetector, phone):
...
class TestChinaHongKongPhoneDetector:
    ...
    @pytest.mark.parametrize(
        "phone",
        [
            # Mobile: 8 chars, starts with 5-9
            "51234567",
            "61234567",
            "71234567",
            "81234567",
            "91234567",
            # Mobile: 12 chars with +852
            "+85251234567",
            "+85261234567",
            "+85271234567",
            "+85281234567",
            "+85291234567",
            # Fixed line: 8 chars, starts with 2-3
            "21234567",
            "31234567",
            # Fixed line: 12 chars with +852
            "+85221234567",
            "+85231234567",
        ],
    )
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            "5123456",  # 7 chars
            "512345678",  # 9 chars
            "+8525123456",  # 11 chars with +852, not 12
            "+852512345678",  # 13 chars with +852, not 12
        ],
    )
    def test_invalid(self, detector: PhoneDetector, phone):
        """Test invalid phone numbers."""
...
class TestChinaMacauPhoneDetector:
    ...
    @pytest.mark.parametrize(
        "phone",
        [
            # Mobile: 8 chars, starts with 6
            "61234567",
            "62345678",
            "63456789",
            # Mobile: 12 chars with +853
            "+85361234567",
            "+85362345678",
            "+85363456789",
            # Fixed line: 8 chars, starts with 28
            "28123456",
            "28234567",
            "28345678",
            # Fixed line: 12 chars with +853
            "+85328123456",
            "+85328234567",
            "+85328345678",
        ],
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            "6123456",  # 7 chars
            "612345678",  # 9 chars
            "+8536123456",  # 11 chars with +853
            "+853612345678",  # 13 chars with +853
            ...
            "2812345",  # 7 chars
            "281234567",  # 9 chars
            "+8532812345",  # 11 chars with +853
            "+853281234567",  # 13 chars with +853
        ],
    )
    def test_invalid(self, detector: PhoneDetector, phone):
        """Test invalid phone numbers."""
...
class TestChinaTaiwanPhoneDetector:
    ...
    @pytest.mark.parametrize(
        "phone",
        [
            # Mobile: 10 chars, starts with 09
            "0912345678",
            "0923456789",
            "0934567890",
            # Mobile: 13 chars with +886
            "+886912345678",
            "+886923456789",
            "+886934567890",
            # Fixed line: 9 chars, starts with 02-08
            "021234567",
            "031234567",
            "041234567",
            "051234567",
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            # Mobile: wrong length
            "091234567",  # 9 chars
            "09123456789",  # 11 chars
            "+88691234567",  # 12 chars with +886
            "+8869123456789",  # 14 chars with +886
            ...
            "2123456",  # 7 chars
            "212345678",  # 9 chars
            "+8862123456",  # 11 chars with +886
            "+886212345678",  # 13 chars with +886
        ],
    )
    def test_invalid(self, detector: PhoneDetector, phone):
        """Test invalid phone numbers."""
