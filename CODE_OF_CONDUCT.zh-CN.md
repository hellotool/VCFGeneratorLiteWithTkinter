...
[更多翻译](https://www.contributor-covenant.org/translations/)
...
社区领导有权力和责任删除、编辑或拒绝与本行为准则不相符的评论（comment）、提交（commits）、代码、维基（wiki）编辑、议题（issues）或其他贡献，并在适当时说明管理决策的原因。
...
辱骂、骚扰或其他不可接受的行为可通过 [jesse205@qq.com](mailto:jesse205@qq.com) 向负责监督的社区领袖报告。
所有投诉都将得到及时和公平的审查和调查。
