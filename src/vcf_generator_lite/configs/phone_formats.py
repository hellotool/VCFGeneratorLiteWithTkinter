...
PHONE_FORMATS = [
    CountryPhoneFormat(
        ...
        name=LazyPgettext("phone_format.chinese.mainland", "Chinese mainland"),
        rules=[
    ...
    CountryPhoneFormat(
        ...
        name=LazyPgettext("phone_format.chinese.hongkong", "Hong Kong, China"),
        rules=[
    ...
    CountryPhoneFormat(
        ...
        name=LazyPgettext("phone_format.chinese.macau", "Macau, China"),
        rules=[
    ...
    CountryPhoneFormat(
        ...
        name=LazyPgettext("phone_format.chinese.taiwan", "Taiwan, China"),
        rules=[
